...
export default function ForgotPassword({ onBack }) {
  ...
  const inputStyle = {
    width: '100%', padding: '12px 14px 12px 38px', marginTop: '6px',
    ...
    <div style={{ minHeight: '100vh', background: '#EEF2F7', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Poppins', sans-serif", padding: '2rem' }}>
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ display: 'inline-flex', background: '#0D2E4E', borderRadius: '16px', padding: '1.5rem 2.5rem' }}>
            <svg width="200" height="60" viewBox="0 0 280 88">
        ...
        <div style={{ background: 'white', borderRadius: '12px', padding: '2rem', border: '1px solid #DDE3EC', boxShadow: '0 4px 16px rgba(0,0,0,0.08)' }}>
          {sent ? (
            <div style={{ textAlign: 'center', padding: '1rem 0' }}>
              ...
              <h2 style={{ fontSize: '18px', fontWeight: '700', color: '#0D2E4E', margin: '0 0 8px' }}>Email envoye !</h2>
              <p style={{ fontSize: '13px', color: '#64748B', lineHeight: 1.6, margin: '0 0 1.5rem' }}>
                Si cet email existe, vous recevrez un lien de reinitialisation valable <strong>2 heures</strong>.
              </p>
              <div style={{ padding: '10px 14px', background: '#FEF3C7', borderRadius: '8px', border: '1px solid #FCD34D', marginBottom: '1.5rem' }}>
                <p style={{ fontSize: '12px', color: '#92400E', margin: 0 }}>
                  Verifiez aussi vos spams si vous ne recevez pas l'email.
                </p>
              </div>
            ...
            <>
              <div style={{ marginBottom: '1.5rem' }}>
                <h2 style={{ fontSize: '20px', fontWeight: '700', color: '#0D2E4E', margin: 0 }}>Mot de passe oublie</h2>
              ...
              <div style={{ textAlign: 'center', paddingTop: '1rem', borderTop: '1px solid #DDE3EC' }}>
               ...
               <button onClick={onBack} style={{ background: 'none', border: 'none', color: '#1A4B7A', fontWeight: '600', cursor: 'pointer', fontSize: '13px', fontFamily: 'Poppins, sans-serif' }}>
                  Retour a la connexion
                </button>
              </div>
            </>
        ...
        <div style={{ textAlign: 'center', marginTop: '1.5rem' }}>
          <p style={{ fontSize: '12px', color: '#94A3B8', margin: 0 }}>2026 Salama Data - Tous droits reserves</p>
