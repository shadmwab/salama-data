...
<div style={{ padding: '1rem 1.5rem', background: 'rgba(0,0,0,0.2)' }}>
  ...
  {/* Version */}
  <p style={{ color: '#5A8AA8', fontSize: '11px', marginBottom: '8px' }}>Salama Data v2.0</p>

  {/* Statut connexion */}
  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '6px 10px', borderRadius: '6px', background: isOnline ? 'rgba(29,158,117,0.15)' : 'rgba(186,117,23,0.15)', marginBottom: '8px' }}>
  ...
  {/* Boutons Profil + Sortir */}
  <div style={{ display: 'flex', gap: '6px' }}>
    <button onClick={() => onNavigate('profil')} style={{
      flex: 1, background: currentPage === 'profil' ? 'rgba(0,158,219,0.2)' : 'rgba(255,255,255,0.08)',
      color: '#A8C8E0', border: 'none', borderRadius: '6px',
      padding: '7px 10px', fontSize: '11px', cursor: 'pointer',
      fontFamily: "'Poppins', sans-serif", fontWeight: '600',
      display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '5px'
    }}>
      <Icon name="settings" size={12} color="#A8C8E0" />
      Profil
    </button>
    <button onClick={onLogout} style={{
      flex: 1, background: 'rgba(255,255,255,0.08)', color: '#A8C8E0',
      border: 'none', borderRadius: '6px', padding: '7px 10px',
